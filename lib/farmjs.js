...
exports.HEADER_INSTANCE     = 'x-farmjs-instance';
...
Router.prototype._handlers = {
    ...
    reqid: function(req, res, next) {
        ...
        res.header(exports.HEADER_REQID, req.reqid);
        res.header(exports.HEADER_INSTANCE, req.options.instance);
    ...
    /**
     * Emit x-farmjs-instance on all responses
     */
    ...
    allowCrossDomain: function(req, res, next) {
        ...
        var allowedHeaders = [
            'Content-Type',
            exports.HEADER_URL,
            exports.HEADER_REQID,
            exports.HEADER_APP,
            exports.HEADER_APP_FULLNAME,
            exports.HEADER_INSTANCE,
        ];
    ...
    inst: function(req, res, next) {
        ...
        var inst = req.hints.$inst || req.headers[exports.HEADER_INSTANCE];
